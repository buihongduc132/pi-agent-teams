...
This project is indexed by GitNexus as **pi-agent-teams** (3589 symbols, 6664 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/pi-agent-teams/context` | Codebase overview, check index freshness |
| `gitnexus://repo/pi-agent-teams/clusters` | All functional areas |
| `gitnexus://repo/pi-agent-teams/processes` | All execution flows |
| `gitnexus://repo/pi-agent-teams/process/{name}` | Step-by-step execution trace |
